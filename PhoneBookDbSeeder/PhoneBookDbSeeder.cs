    ...
    public class PhoneBookDbSeeder : IDbSeeder
    {
        ...
        private async Task SeedData()
        {
            if (!await _dbContext.Groups.AnyAsync())
            {
                ...
                {
                    new GroupDb {Name = "Семья"},
                    new GroupDb {Name = "Работа"},
                    new GroupDb {Name = "Друзья"},
                    new GroupDb {Name = "Общие"}
                });
            }
            ...
            if (!await _dbContext.PhoneCategories.AnyAsync())
            {
                ...
                {
                    new PhoneCategoryDb {Name = "Домашний"},
                    new PhoneCategoryDb {Name = "Рабочий"},
                    new PhoneCategoryDb {Name = "Мобильный"},
                });
            }
        }
    }
